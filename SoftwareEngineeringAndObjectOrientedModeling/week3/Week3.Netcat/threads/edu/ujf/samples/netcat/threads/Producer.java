...
public class Producer {
  ...
  Producer(String name, InputStream in, Channel channel) {
    this.name = name;
  ...
  void burst() throws IOException {
    ...
    for (;;) {
      ...
      Element elem = new Element(chars, 0, chars.length);
      list.add(elem);
      chars = new char[] {'\n'};
      elem = new Element(chars, 0, chars.length);
      list.add(elem);
      echoLine(list);
    }
  }
