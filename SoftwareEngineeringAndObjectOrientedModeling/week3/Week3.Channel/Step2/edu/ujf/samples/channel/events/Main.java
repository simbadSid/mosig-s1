...
public class Main {
  ...
  static private void accept(Executor executor) throws IOException {
    ...
    Consumer stdout = new Consumer(System.out);
    Channel stdch = new Channel(stdout);
    Producer sockin = new Producer("sockin", in, stdch);

    sockin.produce(executor);
  }
  ...
  static private void connect(Executor executor) throws IOException {
    ...
    Consumer sockout = new Consumer(ps);
    Channel sockch = new Channel(sockout);
